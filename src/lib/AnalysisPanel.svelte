      ...
      <div class="form-scroll">
        <div class="field-row">
          ...
          <div class="field"><label>Certainty</label>
            <select bind:value={fCert}><option value={1}>1 Confirmed</option><option value={2}>2 Probable</option><option value={3}>3 Uncertain</option></select>
          </div>
        </div>
        ...
        <div class="field-row">
          <div class="field"><label>Root جذر</label><input class="arabic" bind:value={fRoot} oninput={onRootInput} placeholder="كتب"></div>
